...
export default function Institutional() {
  ...
  return (
    <section id="institucional" className="w-full pb-20 md:p-0 bg-white" >
      <div className="w-full bg-blue-500 text-center py-10" style={{backgroundImage: 'url("' + bginstitucional + '")' , backgroundSize: 'auto 100%'}}>
        <span style={{maxWidth: 600 , margin: '0 auto' , display: 'block'}}>
