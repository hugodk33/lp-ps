        ...
        <div className="flex flex-col md:flex-row gap-5 items-center">
          ...
          <div className="md:w-1/2">
            ...
            {/* <div className="flex flex-col sm:flex-row gap-1">
              ...
              <Button
                variant="outline"
                className="border-2 border-primary text-primary hover:bg-primary/5 font-bold px-5 py-3 rounded-lg transition-all duration-300"
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-neutral-dark">+5 mil clientes</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-accent rounded-full" />
          ...
          <div className="md:w-1/2">
            ...
            <img src={familia} alt="Família" className="w-full inset-0 bg-white/30 backdrop-blur-sm rounded-3xl border border-white/50" style={{maxWidth: 500, margin: '0 auto'}}/>
          </div>
        </div>
      </div>
    </section>
